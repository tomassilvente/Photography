  ...
  return (
    <div id="portafolio" className='text-white pb-10 font bg-[#c6c6ae]'>
        {tipos.map((tipo,index) =>(
          <>
            {index % 2 == 0 
              ? <img className='bg-[#3F3816] w-full h-[100%] mb-[-10px] sm:mb-0' src='../common/wavesNegativeTop.svg' />
              : <img className='bg-[#c6c6ae] w-full h-[100%] mb-[-10px] sm:mb-0' src='../common/wavesNegative.svg' />
            }
